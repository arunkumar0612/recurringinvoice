...
class InvoiceTemplate {
  InvoiceTemplate({required this.instInvoice});
  ...
  late final pw.Font Helvetica;
  late final pw.Font Helvetica_bold;
  ...
  pw.Widget contentTable(pw.Context context) {
    ...
    return pw.TableHelper.fromTextArray(
      ...
      headerDecoration: pw.BoxDecoration(borderRadius: const pw.BorderRadius.all(pw.Radius.circular(2)), color: baseColor),
      headerHeight: 22,
      cellHeight: 30,
      cellAlignments: {
      ...
      headerStyle: pw.TextStyle(font: Helvetica_bold, color: PdfColors.white, fontSize: 10, fontWeight: pw.FontWeight.bold),
      cellStyle: pw.TextStyle(font: Helvetica, color: _darkColor, fontSize: 10),
      cellDecoration: (int rowIndex, dynamic cellData, int colIndex) {
        // Apply different colors for even and odd columns
        return pw.BoxDecoration(color: colIndex % 2 == 0 ? PdfColors.green50 : PdfColors.white);
      },
      ...
      data: List<List<String>>.generate(instInvoice.siteData.length, (row) => List<String>.generate(tableHeaders.length, (col) => instInvoice.siteData[row].getIndex(col).toString())),
    );
  }
  ...
  pw.Widget tax_table(pw.Context context) {
    return pw.Column(
      children: [
        ...
        pw.Row(crossAxisAlignment: pw.CrossAxisAlignment.start, children: [pw.SizedBox(width: 100)]),
      ],
    );
  }
    ...
    return pw.Container(
      ...
      child: pw.Column(
        ...
        children: [
          ...
          pw.SizedBox(height: 8),
          pw.Row(mainAxisAlignment: pw.MainAxisAlignment.spaceBetween, children: [regular('Round off : \n${instInvoice.finalCalc.differene}', 10), regular(instInvoice.finalCalc.roundOff, 10)]),
